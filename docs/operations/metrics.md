...
| `repo_guard_githuborganization_status_payload_bytes` | Gauge | `github`, `organization` | JSON byte size of the status subresource before each write. Alert when > 1 MB. |
