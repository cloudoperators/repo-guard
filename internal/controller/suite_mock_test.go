...
func startMockGitHubServer() {
	...
	cfg := internalgithub.MockConfig{
		...
		Teams: []internalgithub.MockTeam{
			...
			// Teams used by the repository-assignment test (githuborganization_repository_test.go)
			{ID: 7, Name: TEST_DEFAULT_PUBLIC_REPO_PULL, Slug: TEST_DEFAULT_PUBLIC_REPO_PULL},
			{ID: 8, Name: TEST_DEFAULT_PUBLIC_REPO_PUSH, Slug: TEST_DEFAULT_PUBLIC_REPO_PUSH},
			{ID: 9, Name: TEST_DEFAULT_PUBLIC_REPO_ADMIN, Slug: TEST_DEFAULT_PUBLIC_REPO_ADMIN},
			{ID: 10, Name: TEST_DEFAULT_PRIVATE_REPO_PULL, Slug: TEST_DEFAULT_PRIVATE_REPO_PULL},
			{ID: 11, Name: TEST_DEFAULT_PRIVATE_REPO_PUSH, Slug: TEST_DEFAULT_PRIVATE_REPO_PUSH},
			{ID: 12, Name: TEST_DEFAULT_PRIVATE_REPO_ADMIN, Slug: TEST_DEFAULT_PRIVATE_REPO_ADMIN},
			{ID: 13, Name: TEST_CUSTOM_TEAM, Slug: TEST_CUSTOM_TEAM},
