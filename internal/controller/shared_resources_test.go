...
func loadTestEnv() map[string]string {
	...
	keys := []string{
		...
		"EMP_HTTP_USERNAME", "EMP_HTTP_PASSWORD", "EMP_HTTP_CLIENT_ID", "EMP_HTTP_CLIENT_SECRET", "EMP_HTTP_GROUP_ID", "EMP_HTTP_USER_INTERNAL_USERNAME",
...
func initSharedResources() {
	...
	githubOrganizationGreenhouseSandboxForOrganizationTests = &repoguardsapv1.GithubOrganization{
		ObjectMeta: metav1.ObjectMeta{
			...
			Labels: map[string]string{
				...
				"repo-guard.cloudoperators.dev/addRepositoryTeam":       "false",
				"repo-guard.cloudoperators.dev/removeRepositoryTeam":    "false",
	...
	githubOrganizationGreenhouseSandboxForTTLTests = &repoguardsapv1.GithubOrganization{
		ObjectMeta: metav1.ObjectMeta{
			...
			Namespace: ns,
			Labels: map[string]string{
				"repo-guard.cloudoperators.dev/addOrganizationOwner":    "false",
				"repo-guard.cloudoperators.dev/removeOrganizationOwner": "false",
				"repo-guard.cloudoperators.dev/addRepositoryTeam":       "false",
				"repo-guard.cloudoperators.dev/removeRepositoryTeam":    "false",
				"repo-guard.cloudoperators.dev/addTeam":                 "false",
				"repo-guard.cloudoperators.dev/removeTeam":              "false",
			},
		},
		Spec: repoguardsapv1.GithubOrganizationSpec{
			Github:         TEST_ENV["GITHUB_KUBERNETES_RESOURCE_NAME"],
