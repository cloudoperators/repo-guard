...
func initSharedResources() {
	...
	githubOrganizationGreenhouseSandboxForOrganizationTests = &repoguardsapv1.GithubOrganization{
		ObjectMeta: metav1.ObjectMeta{
			...
			Labels: map[string]string{
				...
				"repoguard.cloudoperators.dev/addRepositoryTeam":       "false",
				"repoguard.cloudoperators.dev/removeRepositoryTeam":    "false",
	...
	githubOrganizationGreenhouseSandboxForTTLTests = &repoguardsapv1.GithubOrganization{
		ObjectMeta: metav1.ObjectMeta{
			...
			Namespace: ns,
			Labels: map[string]string{
				"repoguard.cloudoperators.dev/addOrganizationOwner":    "false",
				"repoguard.cloudoperators.dev/removeOrganizationOwner": "false",
				"repoguard.cloudoperators.dev/addRepositoryTeam":       "false",
				"repoguard.cloudoperators.dev/removeRepositoryTeam":    "false",
				"repoguard.cloudoperators.dev/addTeam":                 "false",
				"repoguard.cloudoperators.dev/removeTeam":              "false",
			},
		},
		Spec: repoguardsapv1.GithubOrganizationSpec{
			Github:         TEST_ENV["GITHUB_KUBERNETES_RESOURCE_NAME"],
